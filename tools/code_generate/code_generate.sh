...
# v2 needs to be merged into cublas.h manually
#python3 code_generate.py -t cublas_v2 -f include/cublas_v2.h -o output
# mkdir -p ../../src/cublas
...
# cublasXt needs to be merged into cublas.h manually
#python3 code_generate.py -t cublasXt -f include/cublasXt.h -o output
...
# v2 needs to be merged to cusparse.h manually
#python3 code_generate.py -t cusparse_v2 -f include/cusparse_v2.h -o output
