...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaDeviceReset(void ) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaDeviceSynchronize(void ) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaDeviceGetTexture1DLinearMaxWidth(size_t * maxWidthInElements, const struct cudaChannelFormatDesc * fmtDesc, int device) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaIpcOpenMemHandle(void * * devPtr, cudaIpcMemHandle_t handle, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaDeviceFlushGPUDirectRDMAWrites(enum cudaFlushGPUDirectRDMAWritesTarget target, enum cudaFlushGPUDirectRDMAWritesScope scope) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaThreadExit(void ) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaThreadSynchronize(void ) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaGetLastError(void ) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaPeekAtLastError(void ) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaDeviceGetNvSciSyncAttributes(void * nvSciSyncAttrList, int device, int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaDeviceGetP2PAttribute(int * value, enum cudaDeviceP2PAttr attr, int srcDevice, int dstDevice) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaStreamCreateWithPriority(cudaStream_t * pStream, unsigned int flags, int priority) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaCtxResetPersistingL2Cache(void ) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaStreamGetAttribute(cudaStream_t hStream, enum cudaStreamAttrID attr, union cudaStreamAttrValue * value_out) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaStreamSetAttribute(cudaStream_t hStream, enum cudaStreamAttrID attr, const union cudaStreamAttrValue * value) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamAddCallback(cudaStream_t stream, cudaStreamCallback_t callback, void * userData, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaStreamAttachMemAsync(cudaStream_t stream, void * devPtr, size_t length, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamIsCapturing(cudaStream_t stream, enum cudaStreamCaptureStatus * pCaptureStatus) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamGetCaptureInfo(cudaStream_t stream, enum cudaStreamCaptureStatus * pCaptureStatus, unsigned long long * pId) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamGetCaptureInfo_v2(cudaStream_t stream, enum cudaStreamCaptureStatus * captureStatus_out, unsigned long long * id_out, cudaGraph_t * graph_out, const cudaGraphNode_t * * dependencies_out, size_t * numDependencies_out) {
    HOOK_TRACE_PROFILE("cudaStreamGetCaptureInfo_v2");
    using func_ptr =   cudaError_t (*)(cudaStream_t, enum cudaStreamCaptureStatus *, unsigned long long *, cudaGraph_t *, const cudaGraphNode_t * *, size_t *);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamUpdateCaptureDependencies(cudaStream_t stream, cudaGraphNode_t * dependencies, size_t numDependencies, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaEventRecordWithFlags(cudaEvent_t event, cudaStream_t stream, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaImportExternalMemory(cudaExternalMemory_t * extMem_out, const struct cudaExternalMemoryHandleDesc * memHandleDesc) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaExternalMemoryGetMappedBuffer(void * * devPtr, cudaExternalMemory_t extMem, const struct cudaExternalMemoryBufferDesc * bufferDesc) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaExternalMemoryGetMappedMipmappedArray(cudaMipmappedArray_t * mipmap, cudaExternalMemory_t extMem, const struct cudaExternalMemoryMipmappedArrayDesc * mipmapDesc) {
    HOOK_TRACE_PROFILE("cudaExternalMemoryGetMappedMipmappedArray");
    using func_ptr =   cudaError_t (*)(cudaMipmappedArray_t *, cudaExternalMemory_t, const struct cudaExternalMemoryMipmappedArrayDesc *);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaImportExternalSemaphore(cudaExternalSemaphore_t * extSem_out, const struct cudaExternalSemaphoreHandleDesc * semHandleDesc) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaSignalExternalSemaphoresAsync(const cudaExternalSemaphore_t * extSemArray, const struct cudaExternalSemaphoreSignalParams * paramsArray, unsigned int numExtSems, cudaStream_t stream) {
    HOOK_TRACE_PROFILE("cudaSignalExternalSemaphoresAsync");
    using func_ptr =   cudaError_t (*)(const cudaExternalSemaphore_t *, const struct cudaExternalSemaphoreSignalParams *, unsigned int, cudaStream_t);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaWaitExternalSemaphoresAsync(const cudaExternalSemaphore_t * extSemArray, const struct cudaExternalSemaphoreWaitParams * paramsArray, unsigned int numExtSems, cudaStream_t stream) {
    HOOK_TRACE_PROFILE("cudaWaitExternalSemaphoresAsync");
    using func_ptr =   cudaError_t (*)(const cudaExternalSemaphore_t *, const struct cudaExternalSemaphoreWaitParams *, unsigned int, cudaStream_t);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaLaunchKernel(const void * func, dim3 gridDim, dim3 blockDim, void * * args, size_t sharedMem, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaLaunchCooperativeKernel(const void * func, dim3 gridDim, dim3 blockDim, void * * args, size_t sharedMem, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaLaunchCooperativeKernelMultiDevice(struct cudaLaunchParams * launchParamsList, unsigned int numDevices, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaOccupancyMaxActiveBlocksPerMultiprocessor(int * numBlocks, const void * func, int blockSize, size_t dynamicSMemSize) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaOccupancyAvailableDynamicSMemPerBlock(size_t * dynamicSmemSize, const void * func, int numBlocks, int blockSize) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(int * numBlocks, const void * func, int blockSize, size_t dynamicSMemSize, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMallocArray(cudaArray_t * array, const struct cudaChannelFormatDesc * desc, size_t width, size_t height, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMalloc3DArray(cudaArray_t * array, const struct cudaChannelFormatDesc * desc, struct cudaExtent extent, unsigned int flags) {
    HOOK_TRACE_PROFILE("cudaMalloc3DArray");
    using func_ptr =   cudaError_t (*)(cudaArray_t *, const struct cudaChannelFormatDesc *, struct cudaExtent, unsigned int);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMallocMipmappedArray(cudaMipmappedArray_t * mipmappedArray, const struct cudaChannelFormatDesc * desc, struct cudaExtent extent, unsigned int numLevels, unsigned int flags) {
    HOOK_TRACE_PROFILE("cudaMallocMipmappedArray");
    using func_ptr =   cudaError_t (*)(cudaMipmappedArray_t *, const struct cudaChannelFormatDesc *, struct cudaExtent, unsigned int, unsigned int);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetMipmappedArrayLevel(cudaArray_t * levelArray, cudaMipmappedArray_const_t mipmappedArray, unsigned int level) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpy3DPeerAsync(const struct cudaMemcpy3DPeerParms * p, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaArrayGetInfo(struct cudaChannelFormatDesc * desc, struct cudaExtent * extent, unsigned int * flags, cudaArray_t array) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaArrayGetPlane(cudaArray_t * pPlaneArray, cudaArray_t hArray, unsigned int planeIdx) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaArrayGetMemoryRequirements(struct cudaArrayMemoryRequirements * memoryRequirements, cudaArray_t array, int device) {
    HOOK_TRACE_PROFILE("cudaArrayGetMemoryRequirements");
    using func_ptr =   cudaError_t (*)(struct cudaArrayMemoryRequirements *, cudaArray_t, int);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMipmappedArrayGetMemoryRequirements(struct cudaArrayMemoryRequirements * memoryRequirements, cudaMipmappedArray_t mipmap, int device) {
    HOOK_TRACE_PROFILE("cudaMipmappedArrayGetMemoryRequirements");
    using func_ptr =   cudaError_t (*)(struct cudaArrayMemoryRequirements *, cudaMipmappedArray_t, int);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaArrayGetSparseProperties(struct cudaArraySparseProperties * sparseProperties, cudaArray_t array) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMipmappedArrayGetSparseProperties(struct cudaArraySparseProperties * sparseProperties, cudaMipmappedArray_t mipmap) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpyPeer(void * dst, int dstDevice, const void * src, int srcDevice, size_t count) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpy2D(void * dst, size_t dpitch, const void * src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpy2DToArray(cudaArray_t dst, size_t wOffset, size_t hOffset, const void * src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaMemcpy2DToArray");
    using func_ptr =   cudaError_t (*)(cudaArray_t, size_t, size_t, const void *, size_t, size_t, size_t, enum cudaMemcpyKind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpy2DFromArray(void * dst, size_t dpitch, cudaArray_const_t src, size_t wOffset, size_t hOffset, size_t width, size_t height, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaMemcpy2DFromArray");
    using func_ptr =   cudaError_t (*)(void *, size_t, cudaArray_const_t, size_t, size_t, size_t, size_t, enum cudaMemcpyKind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpy2DArrayToArray(cudaArray_t dst, size_t wOffsetDst, size_t hOffsetDst, cudaArray_const_t src, size_t wOffsetSrc, size_t hOffsetSrc, size_t width, size_t height, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaMemcpy2DArrayToArray");
    using func_ptr =   cudaError_t (*)(cudaArray_t, size_t, size_t, cudaArray_const_t, size_t, size_t, size_t, size_t, enum cudaMemcpyKind kind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpyToSymbol(const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaMemcpyToSymbol");
    using func_ptr =   cudaError_t (*)(const void *, const void *, size_t, size_t, enum cudaMemcpyKind kind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpyFromSymbol(void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaMemcpyFromSymbol");
    using func_ptr =   cudaError_t (*)(void *, const void *, size_t, size_t, enum cudaMemcpyKind kind);
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaMemcpyAsync(void * dst, const void * src, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpyPeerAsync(void * dst, int dstDevice, const void * src, int srcDevice, size_t count, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaMemcpy2DAsync(void * dst, size_t dpitch, const void * src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream) {
    HOOK_TRACE_PROFILE("cudaMemcpy2DAsync");
    using func_ptr =    cudaError_t (*)(void *, size_t, const void *, size_t, size_t, size_t, enum cudaMemcpyKind, cudaStream_t);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpy2DToArrayAsync(cudaArray_t dst, size_t wOffset, size_t hOffset, const void * src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream) {
    HOOK_TRACE_PROFILE("cudaMemcpy2DToArrayAsync");
    using func_ptr =   cudaError_t (*)(cudaArray_t, size_t, size_t, const void *, size_t, size_t, size_t, enum cudaMemcpyKind, cudaStream_t);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpy2DFromArrayAsync(void * dst, size_t dpitch, cudaArray_const_t src, size_t wOffset, size_t hOffset, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream) {
    HOOK_TRACE_PROFILE("cudaMemcpy2DFromArrayAsync");
    using func_ptr =   cudaError_t (*)(void *, size_t, cudaArray_const_t, size_t, size_t, size_t, size_t, enum cudaMemcpyKind, cudaStream_t);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpyToSymbolAsync(const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemcpyFromSymbolAsync(void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemset2D(void * devPtr, size_t pitch, int value, size_t width, size_t height) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemset3D(struct cudaPitchedPtr pitchedDevPtr, int value, struct cudaExtent extent) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaMemset2DAsync(void * devPtr, size_t pitch, int value, size_t width, size_t height, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaMemset3DAsync(struct cudaPitchedPtr pitchedDevPtr, int value, struct cudaExtent extent, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPrefetchAsync(const void * devPtr, size_t count, int dstDevice, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemAdvise(const void * devPtr, size_t count, enum cudaMemoryAdvise advice, int device) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemRangeGetAttribute(void * data, size_t dataSize, enum cudaMemRangeAttribute attribute, const void * devPtr, size_t count) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemRangeGetAttributes(void * * data, size_t * dataSizes, enum cudaMemRangeAttribute * attributes, size_t numAttributes, const void * devPtr, size_t count) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaMemcpyToArray(cudaArray_t dst, size_t wOffset, size_t hOffset, const void * src, size_t count, enum cudaMemcpyKind kind) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaMemcpyFromArray(void * dst, cudaArray_const_t src, size_t wOffset, size_t hOffset, size_t count, enum cudaMemcpyKind kind) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaMemcpyArrayToArray(cudaArray_t dst, size_t wOffsetDst, size_t hOffsetDst, cudaArray_const_t src, size_t wOffsetSrc, size_t hOffsetSrc, size_t count, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaMemcpyArrayToArray");
    using func_ptr =    cudaError_t (*)(cudaArray_t, size_t, size_t, cudaArray_const_t, size_t, size_t, size_t, enum cudaMemcpyKind kind);
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaMemcpyToArrayAsync(cudaArray_t dst, size_t wOffset, size_t hOffset, const void * src, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream) {
    HOOK_TRACE_PROFILE("cudaMemcpyToArrayAsync");
    using func_ptr =    cudaError_t (*)(cudaArray_t, size_t, size_t, const void *, size_t, enum cudaMemcpyKind, cudaStream_t);
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaMemcpyFromArrayAsync(void * dst, cudaArray_const_t src, size_t wOffset, size_t hOffset, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream) {
    HOOK_TRACE_PROFILE("cudaMemcpyFromArrayAsync");
    using func_ptr =    cudaError_t (*)(void *, cudaArray_const_t, size_t, size_t, size_t, enum cudaMemcpyKind, cudaStream_t);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPoolSetAttribute(cudaMemPool_t memPool, enum cudaMemPoolAttr attr, void * value) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPoolGetAttribute(cudaMemPool_t memPool, enum cudaMemPoolAttr attr, void * value) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPoolSetAccess(cudaMemPool_t memPool, const struct cudaMemAccessDesc * descList, size_t count) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPoolGetAccess(enum cudaMemAccessFlags * flags, cudaMemPool_t memPool, struct cudaMemLocation * location) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPoolCreate(cudaMemPool_t * memPool, const struct cudaMemPoolProps * poolProps) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMallocFromPoolAsync(void * * ptr, size_t size, cudaMemPool_t memPool, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPoolExportToShareableHandle(void * shareableHandle, cudaMemPool_t memPool, enum cudaMemAllocationHandleType handleType, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPoolImportFromShareableHandle(cudaMemPool_t * memPool, void * shareableHandle, enum cudaMemAllocationHandleType handleType, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPoolExportPointer(struct cudaMemPoolPtrExportData * exportData, void * ptr) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPoolImportPointer(void * * ptr, cudaMemPool_t memPool, struct cudaMemPoolPtrExportData * exportData) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaPointerGetAttributes(struct cudaPointerAttributes * attributes, const void * ptr) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphicsResourceSetMapFlags(cudaGraphicsResource_t resource, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphicsMapResources(int count, cudaGraphicsResource_t * resources, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphicsUnmapResources(int count, cudaGraphicsResource_t * resources, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphicsResourceGetMappedPointer(void * * devPtr, size_t * size, cudaGraphicsResource_t resource) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphicsSubResourceGetMappedArray(cudaArray_t * array, cudaGraphicsResource_t resource, unsigned int arrayIndex, unsigned int mipLevel) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphicsResourceGetMappedMipmappedArray(cudaMipmappedArray_t * mipmappedArray, cudaGraphicsResource_t resource) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaBindTexture(size_t * offset, const struct textureReference * texref, const void * devPtr, const struct cudaChannelFormatDesc * desc, size_t size) {
    HOOK_TRACE_PROFILE("cudaBindTexture");
    using func_ptr =    cudaError_t (*)(size_t *, const struct textureReference *, const void *, const struct cudaChannelFormatDesc *, size_t size);
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaBindTexture2D(size_t * offset, const struct textureReference * texref, const void * devPtr, const struct cudaChannelFormatDesc * desc, size_t width, size_t height, size_t pitch) {
    HOOK_TRACE_PROFILE("cudaBindTexture2D");
    using func_ptr =    cudaError_t (*)(size_t *, const struct textureReference *, const void *, const struct cudaChannelFormatDesc *, size_t, size_t, size_t);
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaBindTextureToArray(const struct textureReference * texref, cudaArray_const_t array, const struct cudaChannelFormatDesc * desc) {
    HOOK_TRACE_PROFILE("cudaBindTextureToArray");
    using func_ptr =    cudaError_t (*)(const struct textureReference *, cudaArray_const_t, const struct cudaChannelFormatDesc *);
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaBindTextureToMipmappedArray(const struct textureReference * texref, cudaMipmappedArray_const_t mipmappedArray, const struct cudaChannelFormatDesc * desc) {
    HOOK_TRACE_PROFILE("cudaBindTextureToMipmappedArray");
    using func_ptr =    cudaError_t (*)(const struct textureReference *, cudaMipmappedArray_const_t, const struct cudaChannelFormatDesc *);
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaGetTextureAlignmentOffset(size_t * offset, const struct textureReference * texref) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaGetTextureReference(const struct textureReference * * texref, const void * symbol) {
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaBindSurfaceToArray(const struct surfaceReference * surfref, cudaArray_const_t array, const struct cudaChannelFormatDesc * desc) {
    HOOK_TRACE_PROFILE("cudaBindSurfaceToArray");
    using func_ptr =    cudaError_t (*)(const struct surfaceReference *, cudaArray_const_t, const struct cudaChannelFormatDesc *);
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaGetSurfaceReference(const struct surfaceReference * * surfref, const void * symbol) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetChannelDesc(struct cudaChannelFormatDesc * desc, cudaArray_const_t array) {
...
HOOK_C_API HOOK_DECL_EXPORT   struct cudaChannelFormatDesc cudaCreateChannelDesc(int x, int y, int z, int w, enum cudaChannelFormatKind f) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaCreateTextureObject(cudaTextureObject_t * pTexObject, const struct cudaResourceDesc * pResDesc, const struct cudaTextureDesc * pTexDesc, const struct cudaResourceViewDesc * pResViewDesc) {
    HOOK_TRACE_PROFILE("cudaCreateTextureObject");
    using func_ptr =   cudaError_t (*)(cudaTextureObject_t *, const struct cudaResourceDesc *, const struct cudaTextureDesc *, const struct cudaResourceViewDesc *);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetTextureObjectResourceDesc(struct cudaResourceDesc * pResDesc, cudaTextureObject_t texObject) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetTextureObjectTextureDesc(struct cudaTextureDesc * pTexDesc, cudaTextureObject_t texObject) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetTextureObjectResourceViewDesc(struct cudaResourceViewDesc * pResViewDesc, cudaTextureObject_t texObject) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaCreateSurfaceObject(cudaSurfaceObject_t * pSurfObject, const struct cudaResourceDesc * pResDesc) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetSurfaceObjectResourceDesc(struct cudaResourceDesc * pResDesc, cudaSurfaceObject_t surfObject) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddKernelNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaKernelNodeParams * pNodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphAddKernelNode");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, const struct cudaKernelNodeParams *);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphKernelNodeGetParams(cudaGraphNode_t node, struct cudaKernelNodeParams * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphKernelNodeSetParams(cudaGraphNode_t node, const struct cudaKernelNodeParams * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphKernelNodeGetAttribute(cudaGraphNode_t hNode, enum cudaKernelNodeAttrID attr, union cudaKernelNodeAttrValue * value_out) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphKernelNodeSetAttribute(cudaGraphNode_t hNode, enum cudaKernelNodeAttrID attr, const union cudaKernelNodeAttrValue * value) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddMemcpyNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaMemcpy3DParms * pCopyParams) {
    HOOK_TRACE_PROFILE("cudaGraphAddMemcpyNode");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, const struct cudaMemcpy3DParms *);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddMemcpyNodeToSymbol(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaGraphAddMemcpyNodeToSymbol");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, const void *, const void *, size_t, size_t, enum cudaMemcpyKind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddMemcpyNodeFromSymbol(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaGraphAddMemcpyNodeFromSymbol");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, void *, const void *, size_t, size_t, enum cudaMemcpyKind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddMemcpyNode1D(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, void * dst, const void * src, size_t count, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaGraphAddMemcpyNode1D");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, void *, const void *, size_t, enum cudaMemcpyKind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphMemcpyNodeGetParams(cudaGraphNode_t node, struct cudaMemcpy3DParms * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphMemcpyNodeSetParams(cudaGraphNode_t node, const struct cudaMemcpy3DParms * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphMemcpyNodeSetParamsToSymbol(cudaGraphNode_t node, const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphMemcpyNodeSetParamsFromSymbol(cudaGraphNode_t node, void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphMemcpyNodeSetParams1D(cudaGraphNode_t node, void * dst, const void * src, size_t count, enum cudaMemcpyKind kind) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddMemsetNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaMemsetParams * pMemsetParams) {
    HOOK_TRACE_PROFILE("cudaGraphAddMemsetNode");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, const struct cudaMemsetParams *);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphMemsetNodeGetParams(cudaGraphNode_t node, struct cudaMemsetParams * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphMemsetNodeSetParams(cudaGraphNode_t node, const struct cudaMemsetParams * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddHostNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaHostNodeParams * pNodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphAddHostNode");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, const struct cudaHostNodeParams *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphAddHostNode"));
    HOOK_CHECK(func_entry);
    return func_entry(pGraphNode, graph, pDependencies, numDependencies, pNodeParams);
}

HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphHostNodeGetParams(cudaGraphNode_t node, struct cudaHostNodeParams * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphHostNodeSetParams(cudaGraphNode_t node, const struct cudaHostNodeParams * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddChildGraphNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, cudaGraph_t childGraph) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddEmptyNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddEventRecordNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, cudaEvent_t event) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddEventWaitNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, cudaEvent_t event) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddExternalSemaphoresSignalNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaExternalSemaphoreSignalNodeParams * nodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphAddExternalSemaphoresSignalNode");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, const struct cudaExternalSemaphoreSignalNodeParams *);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExternalSemaphoresSignalNodeGetParams(cudaGraphNode_t hNode, struct cudaExternalSemaphoreSignalNodeParams * params_out) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExternalSemaphoresSignalNodeSetParams(cudaGraphNode_t hNode, const struct cudaExternalSemaphoreSignalNodeParams * nodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddExternalSemaphoresWaitNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaExternalSemaphoreWaitNodeParams * nodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphAddExternalSemaphoresWaitNode");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, const struct cudaExternalSemaphoreWaitNodeParams *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphAddExternalSemaphoresWaitNode"));
    HOOK_CHECK(func_entry);
    return func_entry(pGraphNode, graph, pDependencies, numDependencies, nodeParams);
}

HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExternalSemaphoresWaitNodeGetParams(cudaGraphNode_t hNode, struct cudaExternalSemaphoreWaitNodeParams * params_out) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExternalSemaphoresWaitNodeSetParams(cudaGraphNode_t hNode, const struct cudaExternalSemaphoreWaitNodeParams * nodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddMemAllocNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, struct cudaMemAllocNodeParams * nodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphAddMemAllocNode");
    using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, struct cudaMemAllocNodeParams *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphAddMemAllocNode"));
    HOOK_CHECK(func_entry);
    return func_entry(pGraphNode, graph, pDependencies, numDependencies, nodeParams);
}

HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphMemAllocNodeGetParams(cudaGraphNode_t node, struct cudaMemAllocNodeParams * params_out) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddMemFreeNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, void * dptr) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaDeviceGetGraphMemAttribute(int device, enum cudaGraphMemAttributeType attr, void * value) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaDeviceSetGraphMemAttribute(int device, enum cudaGraphMemAttributeType attr, void * value) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphNodeFindInClone(cudaGraphNode_t * pNode, cudaGraphNode_t originalNode, cudaGraph_t clonedGraph) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphGetRootNodes(cudaGraph_t graph, cudaGraphNode_t * pRootNodes, size_t * pNumRootNodes) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphGetEdges(cudaGraph_t graph, cudaGraphNode_t * from, cudaGraphNode_t * to, size_t * numEdges) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphNodeGetDependencies(cudaGraphNode_t node, cudaGraphNode_t * pDependencies, size_t * pNumDependencies) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphNodeGetDependentNodes(cudaGraphNode_t node, cudaGraphNode_t * pDependentNodes, size_t * pNumDependentNodes) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddDependencies(cudaGraph_t graph, const cudaGraphNode_t * from, const cudaGraphNode_t * to, size_t numDependencies) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphRemoveDependencies(cudaGraph_t graph, const cudaGraphNode_t * from, const cudaGraphNode_t * to, size_t numDependencies) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphInstantiate(cudaGraphExec_t * pGraphExec, cudaGraph_t graph, cudaGraphNode_t * pErrorNode, char * pLogBuffer, size_t bufferSize) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphInstantiateWithFlags(cudaGraphExec_t * pGraphExec, cudaGraph_t graph, unsigned long long flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecKernelNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, const struct cudaKernelNodeParams * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecMemcpyNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, const struct cudaMemcpy3DParms * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecMemcpyNodeSetParamsToSymbol(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaGraphExecMemcpyNodeSetParamsToSymbol");
    using func_ptr =   cudaError_t (*)(cudaGraphExec_t, cudaGraphNode_t, const void *, const void *, size_t, size_t, enum cudaMemcpyKind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecMemcpyNodeSetParamsFromSymbol(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaGraphExecMemcpyNodeSetParamsFromSymbol");
    using func_ptr =   cudaError_t (*)(cudaGraphExec_t, cudaGraphNode_t, void *, const void *, size_t, size_t, enum cudaMemcpyKind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecMemcpyNodeSetParams1D(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, void * dst, const void * src, size_t count, enum cudaMemcpyKind kind) {
    HOOK_TRACE_PROFILE("cudaGraphExecMemcpyNodeSetParams1D");
    using func_ptr =   cudaError_t (*)(cudaGraphExec_t, cudaGraphNode_t, void *, const void *, size_t, enum cudaMemcpyKind);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecMemsetNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, const struct cudaMemsetParams * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecHostNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, const struct cudaHostNodeParams * pNodeParams) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecChildGraphNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, cudaGraph_t childGraph) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecEventRecordNodeSetEvent(cudaGraphExec_t hGraphExec, cudaGraphNode_t hNode, cudaEvent_t event) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecEventWaitNodeSetEvent(cudaGraphExec_t hGraphExec, cudaGraphNode_t hNode, cudaEvent_t event) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecExternalSemaphoresSignalNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t hNode, const struct cudaExternalSemaphoreSignalNodeParams * nodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphExecExternalSemaphoresSignalNodeSetParams");
    using func_ptr =   cudaError_t (*)(cudaGraphExec_t, cudaGraphNode_t, const struct cudaExternalSemaphoreSignalNodeParams *);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecExternalSemaphoresWaitNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t hNode, const struct cudaExternalSemaphoreWaitNodeParams * nodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphExecExternalSemaphoresWaitNodeSetParams");
    using func_ptr =   cudaError_t (*)(cudaGraphExec_t, cudaGraphNode_t, const struct cudaExternalSemaphoreWaitNodeParams *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphExecExternalSemaphoresWaitNodeSetParams"));
    HOOK_CHECK(func_entry);
    return func_entry(hGraphExec, hNode, nodeParams);
}

HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphNodeSetEnabled(cudaGraphExec_t hGraphExec, cudaGraphNode_t hNode, unsigned int isEnabled) {
    HOOK_TRACE_PROFILE("cudaGraphNodeSetEnabled");
    using func_ptr =   cudaError_t (*)(cudaGraphExec_t, cudaGraphNode_t, unsigned int);
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphNodeGetEnabled(cudaGraphExec_t hGraphExec, cudaGraphNode_t hNode, unsigned int * isEnabled) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecUpdate(cudaGraphExec_t hGraphExec, cudaGraph_t hGraph, cudaGraphNode_t * hErrorNode_out, enum cudaGraphExecUpdateResult * updateResult_out) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphDebugDotPrint(cudaGraph_t graph, const char * path, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaUserObjectCreate(cudaUserObject_t * object_out, void * ptr, cudaHostFn_t destroy, unsigned int initialRefcount, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphRetainUserObject(cudaGraph_t graph, cudaUserObject_t object, unsigned int count, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphReleaseUserObject(cudaGraph_t graph, cudaUserObject_t object, unsigned int count) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetDriverEntryPoint(const char * symbol, void * * funcPtr, unsigned long long flags) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetExportTable(const void * * ppExportTable, const cudaUUID_t * pExportTableId) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaSignalExternalSemaphoresAsync_ptsz(const cudaExternalSemaphore_t * extSemArray, const struct cudaExternalSemaphoreSignalParams_v1 * paramsArray, unsigned int numExtSems, cudaStream_t stream) {
    HOOK_TRACE_PROFILE("cudaSignalExternalSemaphoresAsync_ptsz");
    using func_ptr =   cudaError_t (*)(const cudaExternalSemaphore_t *, const struct cudaExternalSemaphoreSignalParams_v1 *, unsigned int, cudaStream_t);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaSignalExternalSemaphoresAsync_ptsz"));
    HOOK_CHECK(func_entry);
    return func_entry(extSemArray, paramsArray, numExtSems, stream);
}

HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaSignalExternalSemaphoresAsync_v2(const cudaExternalSemaphore_t * extSemArray, const struct cudaExternalSemaphoreSignalParams * paramsArray, unsigned int numExtSems, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaWaitExternalSemaphoresAsync_ptsz(const cudaExternalSemaphore_t * extSemArray, const struct cudaExternalSemaphoreWaitParams_v1 * paramsArray, unsigned int numExtSems, cudaStream_t stream) {
    HOOK_TRACE_PROFILE("cudaWaitExternalSemaphoresAsync_ptsz");
    using func_ptr =   cudaError_t (*)(const cudaExternalSemaphore_t *, const struct cudaExternalSemaphoreWaitParams_v1 *, unsigned int, cudaStream_t);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaWaitExternalSemaphoresAsync_ptsz"));
    HOOK_CHECK(func_entry);
    return func_entry(extSemArray, paramsArray, numExtSems, stream);
}

HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaWaitExternalSemaphoresAsync_v2(const cudaExternalSemaphore_t * extSemArray, const struct cudaExternalSemaphoreWaitParams * paramsArray, unsigned int numExtSems, cudaStream_t stream) {
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamUpdateCaptureDependencies_ptsz(cudaStream_t stream, cudaGraphNode_t * dependencies, size_t numDependencies, unsigned int flags) {
...
HOOK_C_API HOOK_DECL_EXPORT  void __cudaRegisterVar(void * * fatCubinHandle, char * hostVar, char * deviceAddress, const char * deviceName, int ext, size_t size, int constant, int global) {
...
HOOK_C_API HOOK_DECL_EXPORT  void __cudaRegisterManagedVar(void * * fatCubinHandle, void * * hostVarPtrAddress, char * deviceAddress, const char * deviceName, int ext, size_t size, int constant, int global) {
...
HOOK_C_API HOOK_DECL_EXPORT  void __cudaRegisterTexture(void * * fatCubinHandle, const struct textureReference * hostVar, const void * * deviceAddress, const char * deviceName, int dim, int norm, int ext) {
...
HOOK_C_API HOOK_DECL_EXPORT  void __cudaRegisterSurface(void * * fatCubinHandle, const struct surfaceReference * hostVar, const void * * deviceAddress, const char * deviceName, int dim, int ext) {
...
HOOK_C_API HOOK_DECL_EXPORT  void __cudaRegisterFunction(void * * fatCubinHandle, const char * hostFun, char * deviceFun, const char * deviceName, int thread_limit, uint3 * tid, uint3 * bid, dim3 * bDim, dim3 * gDim, int * wSize) {
    HOOK_TRACE_PROFILE("__cudaRegisterFunction");
    using func_ptr =  void (*)(void * *, const char *, char *, const char *, int, uint3 *, uint3 *, dim3 *, dim3 *, int *);
...
HOOK_C_API HOOK_DECL_EXPORT  unsigned __cudaPushCallConfiguration(dim3 gridDim, dim3 blockDim, size_t sharedMem, struct CUstream_st * stream) {
